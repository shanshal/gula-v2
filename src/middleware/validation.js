...
// Note: This validation is kept for backward compatibility but user creation
// is now handled by the auth microservice. User validation should be done
// via API calls to the auth service.
